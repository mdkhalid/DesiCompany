...
const STATUS_CHAT_TEMPLATES: Partial<Record<BookingStatus, ChatMessageTemplate>> = {
  ...
  [BookingStatus.REJECTED]: {
    ...
    provider: '❌ Booking Rejected — You declined the booking from {customerName}.',
  },
  [BookingStatus.ON_THE_WAY]: {
    customer: '🚗 Provider On The Way — {providerName} is on their way to your location.',
    provider: '🚗 On The Way — You marked yourself as on the way to {customerName}.',
  },
  [BookingStatus.WORKING]: {
    customer: '🔧 Service Started — {providerName} has started working on the service.',
  ...
  [BookingStatus.COMPLETED]: {
    ...
    provider: '✅ Service Completed — You completed the job for {customerName}.',
  },
  [BookingStatus.CANCELLED]: {
    customer: '❌ Booking Cancelled — You cancelled the booking with {providerName}.',
 ...
 * }
 */
export function getStatusChatTemplate(status: BookingStatus): ChatMessageTemplate | null {
