...
class AppStrings {
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'unit_rate_field': 'Per-Unit Rate',
      'per_unit': 'Per Unit',
      'per_day': 'Per Day',
      'per_hour': 'Per Hour',
      'quote_based': 'Quote Based',
      'pricing_model': 'Pricing Model',
      'select_pricing_model': 'Select pricing model',
      'all_pricing_models': 'All Options (Flexible)',
      'pricing_model_fixed': 'Fixed',
      'pricing_model_hourly': 'Hourly',
      'pricing_model_daily': 'Daily',
      'pricing_model_per_unit': 'Per Unit',
      'pricing_model_quote_based': 'Quote Based',
      'net_payout_preview': 'Net Payout Preview',
      'invalid_amount': 'Invalid amount',
      'rate_required': 'At least one rate is required',
      'commission_estimate': 'Commission (~{percent}%)',
      'gst_estimate': 'GST (~{percent}%)',
      'provider_earns': 'You earn approx: ₹{amount}',
      ...
      'no_extra_charges': 'No extra charges added yet',
      'my_charges': 'My Charges',
      'rate_fixed': 'Fixed: ₹{rate}',
      'rate_hourly': 'Hourly: ₹{rate}/hr',
      'rate_daily': 'Daily: ₹{rate}/day',
      'rate_per_unit': 'Per unit: ₹{rate}/unit',
      ...
      'gst': 'GST',
      'estimate_depends_on_duration':
          'Final price depends on actual hours/days worked',
    ...
    'hi': {
      ...
      'unit_rate_field': 'प्रति यूनिट दर',
      'per_unit': 'प्रति यूनिट',
      'per_day': 'प्रति दिन',
      'per_hour': 'प्रति घंटा',
      'quote_based': 'कोटेशन आधारित',
      'pricing_model': 'मूल्य निर्धारण मॉडल',
      'select_pricing_model': 'मूल्य निर्धारण मॉडल चुनें',
      'all_pricing_models': 'सभी विकल्प (लचीला)',
      'pricing_model_fixed': 'निश्चित',
      'pricing_model_hourly': 'प्रति घंटा',
      'pricing_model_daily': 'प्रति दिन',
      'pricing_model_per_unit': 'प्रति यूनिट',
      'pricing_model_quote_based': 'कोटेशन आधारित',
      'net_payout_preview': 'शुद्ध भुगतान पूर्वावलोकन',
      'invalid_amount': 'अमान्य राशि',
      'rate_required': 'कम से कम एक दर आवश्यक है',
      'commission_estimate': 'कमीशन (~{percent}%)',
      'gst_estimate': 'जीएसटी (~{percent}%)',
      'provider_earns': 'आप लगभग कमाते हैं: ₹{amount}',
      'extra_charges': 'अतिरिक्त शुल्क',
      'add_charge': 'शुल्क जोड़ें',
      'charge_description': 'शुल्क विवरण',
      'charge_amount': 'राशि (₹)',
      'charge_added': 'शुल्क जोड़ा गया',
      'charge_removed': 'शुल्क हटा दिया गया',
      'no_extra_charges': 'अभी तक कोई अतिरिक्त शुल्क नहीं जोड़ा गया',
      'my_charges': 'मेरे शुल्क',
      'rate_fixed': 'निश्चित: ₹{rate}',
      'rate_hourly': 'प्रति घंटा: ₹{rate}/घंटा',
      'rate_daily': 'प्रति दिन: ₹{rate}/दिन',
      'rate_per_unit': 'प्रति यूनिट: ₹{rate}/यूनिट',
      ...
      'price_breakdown_title': 'मूल्य विवरण',
      'base_price': 'सेवा मूल्य',
      'gst': 'जीएसटी',
      'estimate_depends_on_duration': 'अंतिम मूल्य वास्तविक घंटों/दिनों पर निर्भर करता है',
